...
namespace Api.Controllers
{
    ...
    public class PersonController : ApiBaseController
    {
        ...
        public PersonController(IUnitOfWork context, ILogger<PersonController> logger, IConfiguration configuration, IHikVisionMachineService visionMachineService)
        {
        ...
        public async Task<IActionResult> ReadPersons([FromQuery] PersonFilterDto personFilterDto)
        {
            try
            {
                ...
                else
                {
                    ...
                    PagedResultDto<Person> personDto = new PagedResultDto<Person>()
                    {
                        Data = persons.ToList(),
        ...
        /// <param name="device">person to be updated.</param>
